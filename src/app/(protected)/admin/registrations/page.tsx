...
export default async function Page() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Zgłoszenia"
        description="Zatwierdzenie tworzy konto rodzica (magic link), dziecko trafia do CRM jako „Bez kategorii” i zostaje zapisane na wyjazd. Standardowy mail rejestracyjny wychodzi automatycznie."
      />
