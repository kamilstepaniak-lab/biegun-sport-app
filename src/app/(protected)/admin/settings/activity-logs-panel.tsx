...
const ACTION_LABELS: Record<string, { label: string; color: string }> = {
  ...
  manual_payment_created:   { label: 'Płatność ręczna',      color: 'bg-blue-100 text-blue-800' },
  transfer_allocated:       { label: 'Zaksięgowanie przelewu', color: 'bg-emerald-100 text-emerald-800' },
  payment_reminders_sent:   { label: 'Przypomnienia o płatności', color: 'bg-amber-100 text-amber-800' },
