  ...
  return (
    <PanelCard className={cn('p-5 sm:p-6 space-y-6', hasErrors && 'ring-2 ring-red-300')}>
      <SectionTitle
        ...
        description="Tytuł, opis i konfiguracja wyjazdu"
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-slate-500">Pojawi się w umowie uczestnictwa</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Konfiguracja</p>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-slate-500">Termin potwierdzenia udziału przez rodzica</p>
          </div>
        </div>
      </div>
    </PanelCard>
