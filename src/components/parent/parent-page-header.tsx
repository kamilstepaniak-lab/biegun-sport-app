...
export function ParentPageHeader({
  ...
  return (
    <section className={cn('parent-page-hero overflow-hidden rounded-[14px] bg-blue-600 text-white shadow-sm', className)}>
      ...
      {children && (
        <div className="bg-white p-3 text-slate-900 shadow-sm ring-1 ring-blue-950/5 sm:p-4">
          {children}
        </div>
      )}
    </section>
