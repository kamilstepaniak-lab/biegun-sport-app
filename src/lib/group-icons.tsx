...
// Narciarz (SemiPRO) — własna ikona w stylu lucide
function Skier({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M14.5 7.5 12 11l3 1.5.8 4.5" />
      <path d="M12 11 8.5 9.5" />
      <path d="M15 12.5 19 14" />
      <path d="M3.5 19 17 14.5" />
      <path d="M18.5 16.5 21 21" />
    </svg>
  );
}
...
export function GroupIcon({ name, className }: { name: string; className?: string }) {
  ...
  switch (normalized) {
    ...
    case 'semipro':
      return <Skier className={className} />;
    case 'hero':
